			  ...
			  <h1 class="text-center text-primary">Nasz sklep</h1>
				...
				<div class="row pt-5">
					...
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="<?php echo get_permalink( wc_get_page_id( 'shop' ) );?>/kategorie/substraty" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
					...
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="<?php echo get_permalink( wc_get_page_id( 'shop' ) );?>/kategorie/laboratorium" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
					...
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="<?php echo get_permalink( wc_get_page_id( 'shop' ) );?>/kategorie/suplementy" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
				...
				<div class="row">
					...
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="<?php echo get_permalink( wc_get_page_id( 'shop' ) );?>/kategorie/filtry" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							<img class="position-absolute top-0 bottom-0 end-0 start-0" src="<?php echo get_template_directory_uri();?>/img/slider/slider-3.jpg" alt="..." loading="lazy">
					...
					<div class="categories__col col-md-8 col-sm-12 mb-3">
						<a href="<?php echo get_permalink( wc_get_page_id( 'shop' ) );?>/kategorie/grzybnia" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
