...
?>
	...
	<main id="primary" class="site-main">
		...
		<section class="page-title-header pt-5 pb-5">
			<div class="container">
			  <h1 class="text-center text-primary">Filtry</h1>
			    <div class="row pt-5 align-items-center">
        		    <div class="col-md-6 col-sm-12 pb-5"><img class="" src="<?php echo get_template_directory_uri();?>/img/slider/hepa.svg" alt="filtry HEPA" loading="lazy"></div>  
		...
		<section  class="pt-5 pb-5 bg-white">
		    <div class="container">
          <div class="pb-5">
				    <?php echo do_shortcode('[products columns=4 category=filtry]'); ?>
          </div>
	      </div>
    </section>
	</main>
